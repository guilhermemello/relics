Relics::Application.routes.draw do
  ...
  resources :eventos
  resources :pecas
  resources :eleicoes, :path => "administracao"
  get 'eleicoes/verificar_irmao/:cim' => 'eleicoes#verificar_irmao'
  ...
  get 'verificar_fundador_ja_adicionado/:cim' => 'fundadores#verificar_fundador_ja_adicionado'
